...
function SignIn() {
  ...
  const { serverUrl, setUserData, speakResponse } = useContext(userDataContext);
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      // ✅ Only speak here, one time
      speakResponse(`Hello ${result.data.name}, welcome back!`);

      // Small delay so TTS starts before navigating
